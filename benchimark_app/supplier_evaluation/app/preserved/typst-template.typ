...
// Key Findings 3    
    grid(
      ...
      rows: (100pt,100pt),
      gutter: 15pt,
      grid.cell(colspan: 1,align: center + horizon, text(size: 20pt, fill:rgb("#7C563A") ,"Overview")),
      grid.cell(
        colspan: 1,
        align: horizon,
      ...
      grid.cell(colspan: 1,align: center + horizon, text(size: 20pt, fill:rgb("#7C563A") ,"Category")),
      grid.cell(
      colspan: 2,
      align: horizon,
